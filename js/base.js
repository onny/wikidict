...
function get_attributes(trans) {
    var wortart = '[e]';
    $.ajax({
	type: 'GET',
        url: 'http://' + $('#to').val() + '.wiktionary.org/w/api.php',
	async: false,
	cache: false,
        timeout: 30000,
        data: {
...
function show_result(data) {
	...
	if (!($.each(content.iwlinks, function(i, el) {
	...
	}))) { // function each quits without returning true: page exists, but not including our requested language
